    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900">Our Exclusive Categories</h1>
        </div>
                ...
                <Link to={`/categories/${card}`} className="p-4 md:w-1/3 cursor-pointer">
                  <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                    ...
                    <div className="flex-grow">
                      <p className="leading-relaxed text-base">Latest collections from the top most brand across the globe at the most cost effective prices are here for you!!</p>
